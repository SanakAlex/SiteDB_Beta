...
@Retention(RUNTIME)                                                      
@Constraint(validatedBy = LinkFieldUniqueValidator.class)   //Этой аннотацией указывается, какой класс будет проверять на правильность данные.
@Documented
public @interface LinkFieldUnique {
